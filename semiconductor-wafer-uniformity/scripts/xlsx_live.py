...
def set_excel_fingerprint(path, application="Microsoft Excel"):
    """Overwrite the docProps/app.xml Application tag so it does not name the
    generator library (openpyxl). Namespace-free string edit, safe."""
